      ...
      {items.map((item) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative m-0! h-9 w-9 rounded-full border-2 border-white dark:border-zinc-950 object-cover object-top p-0! transition duration-500 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </>
