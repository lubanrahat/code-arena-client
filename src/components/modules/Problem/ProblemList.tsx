...
const difficultyConfig: Record<
  string,
  { label: string; badge: string; stripe: string; avgTime: number }
> = {
  EASY: {
    label: "Easy",
    badge:
...
const companyLogo: Record<string, string> = {
  ...
  Yahoo:
    '<svg viewBox="0 0 52 52" width="52" height="52" xmlns="http://www.w3.org/2000/svg"><text x="26" y="24" text-anchor="middle" font-family="Arial,sans-serif" font-weight="900" font-size="18" fill="#6001D2">Yahoo</text><text x="44" y="20" text-anchor="middle" font-family="Arial,sans-serif" font-weight="900" font-size="10" fill="#6001D2">!</text></svg>',
  LinkedIn:
    '<svg viewBox="0 0 52 52" width="52" height="52" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="2" width="48" height="48" rx="8" fill="#0A66C2"/><rect x="11" y="20" width="7" height="22" fill="#fff"/><circle cx="14.5" cy="14.5" r="4" fill="#fff"/><path d="M24 20h7v3.5s2-3.5 7-3.5c6 0 8 4 8 10v12h-7V32c0-3-1-5-4-5s-4 2.5-4 5v10h-7V20z" fill="#fff"/></svg>',
  Facebook:
    '<svg viewBox="0 0 52 52" width="52" height="52" xmlns="http://www.w3.org/2000/svg"><rect x="0" y="0" width="52" height="52" rx="10" fill="#1877F2"/><path d="M32 10h-4c-4 0-7 3-7 7v4h-4v6h4v14h6V27h4l1-6h-5v-3c0-1.5.7-2 2-2h3V10z" fill="#fff"/></svg>',
  ...
  Directi:
    '<svg viewBox="0 0 52 52" width="52" height="52" xmlns="http://www.w3.org/2000/svg"><circle cx="26" cy="26" r="24" fill="#E8231A"/><text x="26" y="32" text-anchor="middle" font-family="Arial,sans-serif" font-weight="700" font-size="11" fill="#FFFFFF">DIRECTI</text></svg>',
  Twitter:
    '<svg viewBox="0 0 52 52" width="52" height="52" xmlns="http://www.w3.org/2000/svg"><rect width="52" height="52" rx="12" fill="#000"/><path d="M10 10h9l8 10.5 9-10.5h4L28 23l14 19H33L24 30l-10 12H10l13-16L10 10zm5 2 20 26h3L18 12h-3z" fill="#fff"/></svg>',
  ...
  Oracle:
    '<svg viewBox="0 0 80 32" width="90" height="36" xmlns="http://www.w3.org/2000/svg"><ellipse cx="22" cy="16" rx="18" ry="11" fill="none" stroke="#C74634" stroke-width="5.5"/><text x="44" y="21" font-family="Arial,sans-serif" font-weight="700" font-size="16" fill="#C74634">ORACLE</text></svg>',
};
...
function companyInitial(name: string) {
  ...
  return (
    map[name] ?? { char: name.substring(0, 1).toUpperCase(), color: "#888888" }
  );
}
...
function CheckboxDropdown({
  ...
  return (
    <div
      className="absolute top-full left-0 mt-1.5 z-50 min-w-[180px] bg-white dark:bg-zinc-900 border border-border rounded-xl shadow-xl py-2"
    ...
    >
      ...
      <div
        className={cn("overflow-y-auto", searchable ? "max-h-52" : "max-h-64")}
      >
        {filtered.map((opt) => (
          <label
            key={opt}
...
export default function ProblemList() {
  ...
  const handlePickRandom = () => {
    if (sortedProblems.length > 0) {
      const p =
        sortedProblems[Math.floor(Math.random() * sortedProblems.length)];
          ...
          <div className="flex w-full items-center gap-2 overflow-x-auto pb-1 sm:w-auto sm:flex-wrap sm:overflow-visible sm:pb-0">
            ...
            >
              <CheckboxDropdown
                ...
                onToggle={(v) =>
                  toggle(selectedStatuses, setSelectedStatuses, v)
                }
              />
            </DropdownMenu>
            ...
            >
              <CheckboxDropdown
                ...
                onToggle={(v) =>
                  toggle(selectedCompanies, setSelectedCompanies, v)
                }
                searchable
            ...
            >
              <div
                className="absolute top-full left-0 mt-1.5 z-50 min-w-[150px] bg-white dark:bg-zinc-900 border border-border rounded-xl shadow-xl py-1.5"
                style={{ boxShadow: "0 8px 30px rgba(0,0,0,0.12)" }}
              >
