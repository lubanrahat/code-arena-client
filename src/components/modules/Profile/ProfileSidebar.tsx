    ...
    <div className="flex flex-col gap-6 w-full lg:w-72 shrink-0">
      <Card className="w-full border-border bg-card shadow-xs">
        <CardContent className="p-6 flex flex-col items-start gap-4">
          ...
          {user?.isPremium ? (
            <div className="w-full px-3 py-2.5 rounded-xl bg-linear-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/20 flex items-center gap-2.5">
            ...
            <div className="w-full relative group mt-1">
              ...
              <Link
                href="/pricing"
                className="relative w-full flex items-center justify-between px-4 py-3 rounded-xl bg-zinc-950/80 backdrop-blur-md border border-white/10 hover:border-white/20 transition-all shadow-xl overflow-hidden cursor-pointer"
              >
                ...
                <div className="flex items-center gap-3 relative z-10">
                  ...
                  <div className="flex flex-col text-left">
                    ...
                    <span className="text-[10px] text-white/60 font-medium tracking-wider uppercase mt-0.5">
                      Unlock all features
                    </span>
                  </div>
                </div>
